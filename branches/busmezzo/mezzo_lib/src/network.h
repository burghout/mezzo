...
// STATISTICS
	...
	void write_passenger_welfare_summary(ostream& out, double total_gtc, double total_gtc_inv, double total_gtc_walk, double total_gtc_wait, int total_pass); //weighted inv time included by Melina
